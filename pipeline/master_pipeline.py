...
def run_stage(stage_num: int, stage_name: str,
    ...
    try:
        ...
        module_map = {
            1: ("pipeline.stages.stage1_osint", "run"),
            2: ("pipeline.stages.stage2_asset_discovery", "run"),
            3: ("pipeline.stages.stage3_crawling", "run"),
            4: ("pipeline.stages.stage4_dynamic_rendering", "run"),
            5: ("pipeline.stages.stage5_extraction", "run"),
            6: ("pipeline.stages.stage6_evasion", "run"),
            7: ("pipeline.stages.stage7_distributed", "run"),
            8: ("pipeline.stages.stage8_darkweb", "run"),
            9: ("pipeline.stages.stage9_ai_enrichment", "run"),
            10: ("pipeline.stages.stage10_output", "run"),
        }
